...
public class StatisticsViewBetweennessFragment extends Fragment {
	...
	public void updateView() {
		...
		stats.calculateBetweenness(System.currentTimeMillis());
		...
		float betweenness = stats.getBetweenness();
		float idealBetweenness = stats.getIdealBetweenness();
		Number[] successCaseArray = {betweenness};
		Number[] idealCaseArray = {idealBetweenness};
		...
		plot.setTitle(activity.getString(R.string.statistics_control_show_betweenness));
		...
		plot.getGraphWidget().setDomainValueFormat(new BetweennessFormatter());
	...
	private class BetweennessFormatter extends Format {
