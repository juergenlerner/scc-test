 ...
 *
 */
public class AlterAlterAttributeDescriptionListBaseAdapter extends BaseAdapter {

	private static ArrayList<Pair<Pair<String, String>, String>> list;
	
	private SCCMainActivity activity;
	
	public AlterAlterAttributeDescriptionListBaseAdapter(SCCMainActivity activity, 
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(PersonalNetwork.getInstance(activity).getAttributeDirectionType(PersonalNetwork.DOMAIN_ALTER_ALTER, attrName)
        	...
        	if(PersonalNetwork.DYAD_DIRECTION_OUT.equals(dirToken)){
        		directionText = "(" + activity.getString(R.string.direction_text_first_to_second_alter) + ")";
        	} else {
        		directionText = "(" + activity.getString(R.string.direction_text_second_to_first_alter) + ")";
        	}
        }
