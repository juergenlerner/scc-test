...
public class NeighborListBaseAdapter extends BaseAdapter {
	...
	public NeighborListBaseAdapter(SCCMainActivity activity, ArrayList<Pair<String, String>> alterNameAttrInfoList){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(activity).inflate(R.layout.movable_neighbor_list_single_row_view, null);
            viewPair = new Pair<TextView, TextView>(
            		(TextView) convertView.findViewById(R.id.movable_neighbor_list_single_row_field_name),
            		(TextView) convertView.findViewById(R.id.movable_neighbor_list_single_row_field_attribute));
