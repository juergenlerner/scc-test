 ...
 *
 */
public class AddEgoMemoDialog extends DialogFragment {
	...
	public AddEgoMemoDialog(){
		super();
		isExistingEvent = true;
		existingEventHasToBeRemoved = false;
	}

	public static AddEgoMemoDialog getInstance(SCCMainActivity act){
		AddEgoMemoDialog instance = new AddEgoMemoDialog();
	...
	public static AddEgoMemoDialog getInstance(SCCMainActivity act, long eventTime){
		AddEgoMemoDialog.eventTime = eventTime;
		existingEventTime = eventTime;
		activity = act;
		return new AddEgoMemoDialog();
	}
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		final View view = LayoutInflater.from(activity).inflate(R.layout.add_ego_memo_dialog_view, null, false);
		//set date and time
		final TextView dateView = (TextView) view.findViewById(R.id.add_ego_memo_dialog_date_view);
		dateView.setText(dateFormat.format(date));
		final TextView timeView = (TextView) view.findViewById(R.id.add_ego_memo_dialog_time_view);
		timeView.setText(timeFormat.format(date));
		initDataIfEventExists(view);
		//access modify time button
		Button modifyTimeButton = (Button) view.findViewById(R.id.modify_ego_memo_time_button);
		...
		builder.setPositiveButton(R.string.save, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int id) {
				EditText editText = (EditText) view.findViewById(R.id.add_ego_memo_text);
				...
				history.
				setAttributeValueAt(TimeInterval.getTimePoint(eventTime), 
						PersonalNetwork.getEgoMemosAttributeName(),
						Ego.getInstance(),
						"value");//TODO: use value for a title
				...
				history.setSecondaryAttributeValue(datumID, PersonalNetwork.getSecondaryAttributeNameText(), 
						text);
				SCCProperties.getInstance(activity).setPropertyEgoDetailExpandEgoMemos(true);
